...
export default function ManageCreateCoursePage() {
  ...
  const {
    ...
    defaultValues: {
      ...
      categoryId: data?.categories?.data[0]?._id,
  ...
  const onSubmit = async (value) => {
    try {
      ...
      formData.append("tagline", value.tagline);
      ...
      <header className="flex items-center justify-between gap-[30px]">
        <div>
          <h1 className="font-extrabold text-[28px] leading-[42px]">
            {data?.course ? "Edit Course" : "New Course"}
          </h1>
      ...
      >
        ...
        <div className="flex items-center gap-[14px]">
          ...
          <button
            ...
            disabled={data?.course ? isPendingUpdate : isPendingCreate}
          >
