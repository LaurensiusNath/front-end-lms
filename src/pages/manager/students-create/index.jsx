...
export default function ManageStudentCreatePage() {
  ...
  const {
    ...
    resolver: zodResolver(
      studentData === undefined ? createStudentSchema : editStudentSchema
    ),
    defaultValues: {
  ...
  const { isPending: isPendingUpdate, mutateAsync: mutateAsyncUpdate } =
    useMutation({
      mutationFn: (data) => updateStudent(data, studentData._id),
    });
      ...
      <header className="flex items-center justify-between gap-[30px]">
        <div>
          <h1 className="font-extrabold text-[28px] leading-[42px]">
            {studentData === undefined ? "Add" : "Edit"} Student
          </h1>
      ...
      >
        <div className="relative flex flex-col gap-[10px]">
          ...
          <div className="flex items-center gap-[14px]">
            ...
            <button
              ...
              className={`w-12 h-12 rounded-full cursor-pointer z-10 ${
                file !== null ? "" : "hidden"
              }`}
            >
        ...
        <div className="flex items-center gap-[14px]">
          ...
          <button
            type="submit"
            disabled={
              studentData === undefined ? isPendingCreate : isPendingUpdate
            }
            className="w-full rounded-full p-[14px_20px] font-semibold text-[#FFFFFF] bg-[#662FFF] text-nowrap"
          >
            {studentData === undefined ? "Add Now" : "Save Changes"}
          </button>
        </div>
      </form>
    </>
